...
;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="8acb0adb4ac88e1b7d317a7ac10decdc";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["A75nWkSuleIG"]={appId:"mt9QUlJFKGSg",scope:{}};;CloudflareApps.installs["A75nWkSuleIG"].options={"account":{"accountId":"b57i3kHGzLqG","service":"jsguardian"},"free":{"guardInnerHTML":"clean","guardInput":"clean","guardPrompt":"clean","guardTransport":"https-only","guardWhen":"after","guardXSS":"sanitize"}};;CloudflareApps.installs["DdmAbsUZSAiz"]={appId:"0VJ1mCYqPTh4",scope:{}};;CloudflareApps.installs["DdmAbsUZSAiz"].options={"color":{"custom":"#FFDD70","strategy":"custom"},"position":{"value":"bottom-right"},"shape":{"icon":"fancy","radius":0.16,"showBackground":true}};;CloudflareApps.installs["YpNlg1uOXIN3"]={appId:"t8Sk01am_9iA",scope:{}};;CloudflareApps.installs["YpNlg1uOXIN3"].options={"advancedOptions":{"disableOnAJAX":true,"disableOnPushState":true},"color":"yellow","hidePage":false,"showAdvanced":true,"theme":"minimal"};;CloudflareApps.installs["4YWlRibbitvF"]={appId:"Ek_0U0d0YWhZ",scope:{}};;CloudflareApps.installs["4YWlRibbitvF"].options={};;if(CloudflareApps.matchPage(CloudflareApps.installs['4YWlRibbitvF'].URLPatterns)){(function(modules){var installedModules={};function __webpack_require__(moduleId){if(installedModules[moduleId])
...
module.exports=lStorage;}]);};if(CloudflareApps.matchPage(CloudflareApps.installs['A75nWkSuleIG'].URLPatterns)){(function(){"use strict";function cloneObject(obj,done=new Map()){if(done.has(obj)){return done.get(obj);}
...
playback timings (ms):
  ...
  esindex: 0.014
  cdx.remote: 113.731
  LoadShardBlock: 71.535 (3)
  PetaboxLoader3.datanode: 115.448 (5)
  load_resource: 1042.372 (2)
  PetaboxLoader3.resolve: 986.488 (2)
*/